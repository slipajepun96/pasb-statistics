...
<div class="md:m-3 m-2 bg-white w-auto rounded-xl p-3">
    ...
    <div class="flex flex-row">
        ...
        <div class="my-1 ml-1 bg-cyan-900 w-1/2 lg:w-1/6  rounded-lg p-2 text-white hover:bg-cyan-700">
            ...
            <a href="{{route('ffbyield')}}" class="my-1 ml-1 bg-cyan-900 w-fit md:w-fit  rounded-lg p-2 text-white hover:bg-cyan-600">
                <div class="flex-inline"><span class="text-sm hover:underline font-semibold">View <br>Details</span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-lg">
    ...
    <div class="lg:flex lg:flex-row lg:inline-block">
        <div class="h-30 mt-2 m-2 rounded-xl p-1 bg-gray-100 rounded shadow mb-2 w-full lg:w-1/2">
            {!! $chart->container() !!}
        </div>
        <div class="m-2 bg-white p-2 rounded-lg w-full lg:w-1/2">
