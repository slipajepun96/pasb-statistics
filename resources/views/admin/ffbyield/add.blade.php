    ...
    <div class="m-2">
        <form action="{{route('daily_yield-store')}}" method="POST">
            ...
            <div class="mb-4  inline-block md:w-1/6 w-full  m-3"> 
                <label for="ffb_mt" class="block text-gray-700 text-sm font-bold mb-2">Today FFB MT: </label><input type="number" step="any" name="ffb_mt" id="ffb_mt" class="w-full shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
