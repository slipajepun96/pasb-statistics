        ...
        <nav class="flex items-center p-3 flex-wrap">
            ...
            <div class="hidden top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto" id="navigation">
                <div class="lg:inline-flex lg:flex-row lg:ml-auto flex flex-col">
                    ...
                    <a href="#" class="lg:inline-flex lg:w-auto px-3 py-2 rounded hover:bg-gray-200 hover:text-cyan-600"><span>Admin Login</span></a>
                </div>
            </div>
        </nav>
        <h1 class="underline p-6 text-sky-400">Mamonaku</h1>
    </body>

</html>
<?php /**PATH /Users/umarqayyum/Desktop/main/web dev/pasb-statistic/resources/views/welcome.blade.php ENDPATH**/ ?>