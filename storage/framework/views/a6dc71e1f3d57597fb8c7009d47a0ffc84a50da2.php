        ...
        <nav class="flex items-center p-3 flex-wrap bg-white shadow">
            ...
            <div class="hidden top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto" id="navigation">
                <div class="lg:inline-flex lg:flex-row lg:ml-auto flex flex-col">
                    ...
                    <?php if(!Auth::guest()): ?>
                    <a href="<?php echo e(route('main')); ?>" class="lg:inline-flex lg:w-auto px-3 py-2 rounded hover:bg-gray-200 hover:text-cyan-600"><span>Admin Main</span></a>
                    <form action="<?php echo e(route('logout')); ?>" method="POST"> <?php echo csrf_field(); ?> <button type="submit" class="lg:inline-flex lg:w-auto px-3 py-2 rounded hover:bg-red-600 hover:text-white">Logout</button></form>
                    
                    <?php else: ?> 
                    <a href="<?php echo e(route('login')); ?>" class="lg:inline-flex lg:w-auto px-3 py-2 rounded hover:bg-gray-200 hover:text-cyan-600"><span>Admin Login</span></a>
                    <?php endif; ?>
                </div>
            </div>
        </nav>
...
</html><?php /**PATH /Users/umarqayyum/Desktop/main/web dev/pasb-statistic/resources/views/layout/master.blade.php ENDPATH**/ ?>